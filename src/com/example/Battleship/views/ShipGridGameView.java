...
public class ShipGridGameView extends View {
    ...
    static String tag = "ShipGridGameView: ";

    GameActivity controller;
    int size;

    public ShipGridGameView(Context context) {
        super(context);
        setup(context, "Constructor 1");
    }

    public ShipGridGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(context, "Constructor 2");
    }

    public ShipGridGameView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void draw(Canvas g) {
        ...
        controller.updateShipGridViews();
    }
